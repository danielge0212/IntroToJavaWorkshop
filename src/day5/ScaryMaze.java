...
int backgroundColor=-16777214;
int backgroundColor2=-16777216;
System.out.println(mouseColor);
		//6. if the mouse falls off the path (if it is on the background)
		if (mouseColor==backgroundColor || mouseColor==backgroundColor2){scare();}
				// call the scare method
		
		//10. if the mouse is on the end color
				if(mouseColor==-4456429){JOptionPane.showMessageDialog(null, "you won!");}
